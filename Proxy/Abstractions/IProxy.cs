using VoiceAttack.Proxy.Audio;
using VoiceAttack.Proxy.Commands;
using VoiceAttack.Proxy.Logging;
using VoiceAttack.Proxy.Options;
using VoiceAttack.Proxy.Paths;
using VoiceAttack.Proxy.Variables;
using VoiceAttack.Proxy.Versions;

namespace VoiceAttack.Proxy.Abstractions;
