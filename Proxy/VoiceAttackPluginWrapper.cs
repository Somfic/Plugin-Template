...
public class VoiceAttackPluginWrapper
{
    ...
    public static void VA_Init1(dynamic vaProxy)
    {
        ...
        try
        {
            VoiceAttackPlugin.Instance.OnInitialise(VoiceAttackPlugin.Proxy);
        }
        catch (Exception e)
        {
    ...
    public static void VA_Invoke1(dynamic vaProxy)
    {
        ...
        try
        {
            VoiceAttackPlugin.Instance.OnInvoke(VoiceAttackPlugin.Proxy, context);
        } 
        catch (Exception e)
        {
    ...
    public static void VA_StopCommand()
    {
        ...
        try 
        {
            VoiceAttackPlugin.Instance.OnCommandStopped(VoiceAttackPlugin.Proxy);
        }
        catch (Exception e)
        {
    ...
    public static void VA_Exit1(dynamic vaProxy)
    {
        ...
        try
        {
            VoiceAttackPlugin.Instance.OnExit(VoiceAttackPlugin.Proxy);
        }
        catch (Exception e)
        {
